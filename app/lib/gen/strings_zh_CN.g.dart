...
class _TranslationsReceiveOptionsPageZhCn extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(AloeSend 文件夹)';
  @override
...
class _TranslationsAboutPageZhCn extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => '关于 AloeSend';
  @override
  List<String> get description => [
        'AloeSend 是一款基于Localsend的免费开源应用程序，可让您通过本地网络与附近的设备安全地共享文件和信息，而无需互联网连接。',
...
class _TranslationsDonationPageZhCn extends TranslationsDonationPageEn {
  ...
  String get title => '捐赠';
  @override
  String get info => 'AloeSend 免费、开源、无广告。如果您喜欢这款应用程序，可以捐款支持开发。';
  @override
...
class _TranslationsNetworkInterfacesPageZhCn extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info => '默认情况下，AloeSend 使用所有可用的网络接口。您可以在此处排除不需要的网络接口。您需要重新启动服务器以应用更改。';
  @override
  String get preview => '预览';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedZhCn extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'AloeSend 在没有扫描本地网络的权限的情况下无法找到其他设备。请在设置中授予此权限。';
  @override
