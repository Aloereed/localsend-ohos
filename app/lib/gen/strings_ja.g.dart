...
class _TranslationsReceiveOptionsPageJa extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(AloeSend フォルダー)';
  @override
...
class _TranslationsWebSharePageJa extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'AloeSendは自己署名証明書を使用しているため、ブラウザーで証明書を許可する必要があります。';
  @override
...
class _TranslationsAboutPageJa extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'AloeSendについて';
  @override
  List<String> get description => [
        'AloeSendは無料のオープンソースアプリで、インターネットに接続することなく、ローカルネットワーク経由で近くにあるデバイスとファイルやメッセージを安全に共有することができます。',
...
class _TranslationsDonationPageJa extends TranslationsDonationPageEn {
  ...
  String get title => '寄付';
  @override
  String get info => 'AloeSendは無料かつオープンソースで、広告を一切含みません。もしアプリを気に入っていただけたら、寄付で開発を支援することができます。';
  @override
...
class _TranslationsSettingsTabGeneralJa extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'コンテキストメニューにAloeSendを表示';
  @override
...
class _TranslationsSettingsTabOtherJa extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'AloeSendを支援';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedJa extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'ローカルネットワークをスキャンする権限がないと、AloeSendは他のデバイスを見つけることができません。設定よりこの権限を付与してください。';
  @override
...
class _TranslationsDialogsSendModeHelpJa extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'AloeSendをインストールしていない受信者でも、ブラウザでリンクを開くことで選択したファイルをダウンロードできます。';
}
