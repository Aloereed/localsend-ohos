...
class _TranslationsReceiveOptionsPageMn extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(AloeChat.AI-н хавтас)';
  @override
...
class _TranslationsWebSharePageMn extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'AloeChat.AI нь өөрийн гарын үсэг ашигладаг тул үүнийг browser дээрээ хүлээн зөвшөөрнө үү.';
  @override
...
class _TranslationsAboutPageMn extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'AloeChat.AI танилцуулга';
  @override
  List<String> get description => [
        'AloeChat.AI нь үнэгүй, нээлттэй эхийн програм бөгөөд танд интернет холболт шаардлагагүйгээр өөрийн дотоод сүлжээгээр ойролцоох төхөөрөмжүүдтэй файл, мессежийг аюулгүйгээр хуваалцах боломтой.',
...
class _TranslationsDonationPageMn extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'AloeChat.AI нь үнэ төлбөргүй, нээлттэй эх сурвалжтай бөгөөд ямар ч зар сурталчилгаагүй. Хэрэв энэ програм таалагдсан бол хандивын мөнгөөр хөгжлийг дэмжих боломжтой.';
  @override
...
class _TranslationsSettingsTabGeneralMn extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Системийн цэсэнд AloeChat.AI-д харуулах';
  @override
...
class _TranslationsSettingsTabOtherMn extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'AloeChat.AI-г дэмжих';
  @override
