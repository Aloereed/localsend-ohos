...
class _TranslationsReceiveOptionsPageTa extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(AloeSend கோப்புறை)';
  @override
...
class _TranslationsWebSharePageTa extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'AloeSend ஒரு சுய கையொப்பம் செய்யப்பட்ட சான்றிதழைப் பயன்படுத்துகிறது. உங்களின் உலாவியில் அதை ஏற்க வேண்டும்.';
  @override
...
class _TranslationsAboutPageTa extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'AloeSend பற்றி';
  @override
  List<String> get description => [
        'AloeSend என்பது ஒரு இலவச, திறந்த மூல செயலி ஆகும், இது உங்களுக்கு உங்களின் உள்ளூர் நெட்வொர்க்கின் மூலம் அருகிலுள்ள சாதனங்களுடன் இணையம் தேவையின்றி பாதுகாப்பாக கோப்புகள் மற்றும் செய்திகளை பகிர அனுமதிக்கிறது.',
...
class _TranslationsDonationPageTa extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'AloeSend இலவசம், திறந்த மூலமாக உள்ளது மற்றும் விளம்பரங்களின்றி உள்ளது. செயலியை நீங்கள் விரும்பினால், ஒரு தானம் மூலம் வளர்ச்சியை ஆதரிக்கலாம்.';
  @override
...
class _TranslationsTrayTa extends TranslationsTrayEn {
  ...
  @override
  String get close => 'AloeSend-ஐ நிறுத்து';
  @override
...
class _TranslationsSettingsTabGeneralTa extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'சூழல் மெனுவில் AloeSend ஐக் காட்டு';
  @override
...
class _TranslationsSettingsTabOtherTa extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'AloeSend ஐ ஆதரிக்க';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedTa extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'AloeSend உள்நாட்டு நெட்வொர்க்கை ஸ்கேன் செய்ய அனுமதியின்றி சாதனங்களை கண்டறிய முடியாது. தயவுசெய்து அமைப்புகளில் இந்த அனுமதியை வழங்கவும்.';
  @override
...
class _TranslationsDialogsSendModeHelpTa extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'AloeSend நிறுவப்படாத பெறுநர்கள் தங்கள் உலாவியில் இணைப்பைத் திறக்க மூலம் தேர்ந்தெடுக்கப்பட்ட கோப்புகளை பதிவிறக்கம் செய்ய முடியும்.';
}
