...
class _TranslationsNetworkInterfacesPageCs extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Ve výchozím nastavení používá AloeSend všechna dostupná síťová rozhraní. Zde můžete vyloučit nežádoucí sítě. Chcete-li použít změny, musíte restartovat server.';
  @override
...
class _TranslationsWebSharePageCs extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'AloeSend používá self-signed certifikát. Musíte ho přijmout ve vašem prohlížeči.';
  @override
...
class _TranslationsAboutPageCs extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'O aplikaci AloeSend';
  @override
  List<String> get description => [
        'AloeSend je bezplatná aplikace s otevřeným zdrojovým kódem, která vám umožňuje bezpečně sdílet soubory a zprávy s okolními zařízeními přes vaši místní síť, aniž byste potřebovali připojení k internetu.',
...
class _TranslationsDonationPageCs extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'AloeSend je zdarma, open source a bez reklam. Pokud se vám aplikace líbí, můžete její vývoj podpořit darem.';
  @override
...
class _TranslationsTrayCs extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Ukončit AloeSend';
  @override
...
class _TranslationsSettingsTabGeneralCs extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Zobrazit AloeSend v kontextové nabídce';
  @override
...
class _TranslationsSettingsTabOtherCs extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Podpora AloeSend';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedCs extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'AloeSend nemůže najít jiná zařízení, aniž by měl oprávnění skenovat místní síť. Udělte prosím toto oprávnění v nastavení.';
  @override
...
class _TranslationsDialogsSendModeHelpCs extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Příjemci, kteří nemají nainstalovaný AloeSend, si mohou vybrané soubory stáhnout otevřením odkazu ve svém prohlížeči.';
}
