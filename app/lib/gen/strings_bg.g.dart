...
class _TranslationsReceiveOptionsPageBg extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(AloeChat.AI папка)';
  @override
...
class _TranslationsWebSharePageBg extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'AloeChat.AI използва самоподписан сертификат. Трябва да го приемете във вашия браузър.';
  @override
...
class _TranslationsAboutPageBg extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Относно AloeChat.AI';
  @override
  List<String> get description => [
        'AloeChat.AI е безплатно приложение с отворен код, което ви позволява сигурно да споделяте файлове и съобщения с устройства наблизо през вашата локална мрежа, без да се нуждаете от интернет връзка.',
...
class _TranslationsDonationPageBg extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'AloeChat.AI е безплатен, с отворен код и без никакви реклами. Ако харесвате приложението, можете да подкрепите разработката с дарение.';
  @override
...
class _TranslationsTrayBg extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Излезте от AloeChat.AI';
  @override
...
class _TranslationsNetworkInterfacesPageBg extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'По подразбиране, AloeChat.AI използва всички налични мрежови интерфейси. Тук можете да изключите нежелани мрежи. Трябва да рестартирате сървъра, за да приложите промените.';
}
...
class _TranslationsSettingsTabGeneralBg extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Покажи AloeChat.AI в контекстното меню';
  @override
...
class _TranslationsSettingsTabOtherBg extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Поддръжка на AloeChat.AI';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedBg extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'AloeChat.AI не може да намери други устройства, без да има разрешение за сканиране на локалната мрежа. Моля, дайте това разрешение в настройките.';
  @override
...
class _TranslationsDialogsSendModeHelpBg extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Получателите, които нямат инсталиран AloeChat.AI, могат да изтеглят избраните файлове, като отворят връзката в своя браузър.';
}
